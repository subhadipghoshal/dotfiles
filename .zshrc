...
export PATH=/opt/homebrew/bin:/opt/homebrew/Cellar/git/2.43.0/bin:/Users/sghoshal/.pyenv/versions/3.12.0/lib/python3.12/site-packages:/opt/homebrew/opt/libpq/bin:/Users/sghoshal/.local/bin:$GOPATH/bin:$PATH
...
export VISUAL_MODE_INDICATOR="%F{orange}+%f"
